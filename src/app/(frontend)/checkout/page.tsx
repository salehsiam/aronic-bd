            ...
            <div>
              ...
              <div className="mt-4 flex gap-3">
                <button
                  ...
                  className={`flex-1 border px-4 py-3 text-sm font-body text-left transition-colors ${
                    location === 'dhaka'
              ...
              <div className="space-y-3">
                <label
                  className={`flex items-center gap-3 border px-4 py-3.5 cursor-pointer transition-colors ${
                    paymentMethod === 'cod' ? 'border-indigo bg-indigo/5' : 'border-ink/20'
                  }`}
                >
                  <input
                    type="radio"
                ...
                <label
                  className={`flex items-center gap-3 border px-4 py-3.5 cursor-pointer transition-colors ${
                    paymentMethod === 'sslcommerz' ? 'border-indigo bg-indigo/5' : 'border-ink/20'
                  }`}
                >
                  <input
                    type="radio"
                ...
                {items.map((item) => (
                  ...
                  >
                    <div className="relative w-14 h-16 bg-line shrink-0">
                      ...
                      <span className="absolute -top-2 -right-2 bg-ink text-cotton text-[10px] font-mono w-5 h-5 rounded-full flex items-center justify-center">
                        {item.quantity}
                      </span>
                    </div>
                    ...
                    <p className="font-mono text-sm text-ink/70 shrink-0">
